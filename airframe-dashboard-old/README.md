# Airframe Dashboard (Old - Vanilla CSS Version)

**This is the original vanilla CSS version, preserved for reference. The active version is now in `../airframe-dashboard/`**
